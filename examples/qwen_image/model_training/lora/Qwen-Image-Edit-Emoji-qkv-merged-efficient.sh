accelerate launch examples/qwen_image/model_training/train_merged_qkv.py \
  ...
  --dataset_metadata_path /home/kuan/workspace/repos/avatar/fg_special/emoji/all_merged.csv \
  ...
  --output_path "./models/train/Qwen-Image-Edit-Emoji_lora_merged_qkv_1022" \
  --lora_base_model "dit" \
