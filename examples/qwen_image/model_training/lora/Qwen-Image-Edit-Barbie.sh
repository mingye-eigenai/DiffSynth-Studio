accelerate launch examples/qwen_image/model_training/train.py \
  ...
  --dataset_metadata_path /home/kuan/workspace/repos/avatar/fg_special/barbie/all_merged.csv \
  ...
  --output_path "./models/train/Qwen-Image-Edit-Barbie_lora-image-mod-1013" \
  --lora_base_model "dit" \
...
# --dataset_metadata_path data/barbie_981_images.csv\
